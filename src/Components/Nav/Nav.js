    ...
    return (
        <nav className='nav'>
            <ul className='nav__ul'>
                ...
                <li className='nav__li nav__li--description' ><input value={filterName} onChange={e => setFilterName(e.target.value)} className='nav__li__input nav__li nav__li--description' placeholder={maxWidth < 920 ? 'Название' : "Название тикета"} /></li>
